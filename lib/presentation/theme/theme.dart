import 'package:flutter/material.dart';
    ...
    /// Comprehensive theme system for BeerTinder app
    /// Follows Apple Human Interface Guidelines with support for dark mode
    class AppTheme {
      ...
      static final ThemeData lightTheme = ThemeData(
        ...
        textTheme: TextTheme(
          ...
          titleLarge: title3.copyWith(color: lightTextColor, fontWeight: AppFonts.bold),
        ...
        dialogTheme: DialogThemeData(
          ...
          shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(cornerRadius)),
          titleTextStyle: headline.copyWith(color: lightTextColor, fontWeight: AppFonts.semiBold),
          contentTextStyle: body.copyWith(color: lightTextColor),
        ),
      ...
      static final ThemeData darkTheme = ThemeData(
        ...
        textTheme: TextTheme(
          ...
          titleLarge: title3.copyWith(color: darkTextColor, fontWeight: AppFonts.bold),
        ...
        dialogTheme: DialogThemeData(
          backgroundColor: darkCardColor,
          shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(cornerRadius)),
          titleTextStyle: headline.copyWith(color: darkTextColor, fontWeight: AppFonts.semiBold),
          contentTextStyle: body.copyWith(color: darkTextColor),
        ),
        tooltipTheme: TooltipThemeData(
          decoration: BoxDecoration(
